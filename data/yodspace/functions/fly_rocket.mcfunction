...
execute positioned ~ 200 ~ if entity @s[distance=..2] as @e[distance=..2.5,tag=!rocket] at @s in the_end positioned 5000000 125 5000000 run tp @s ~ ~ ~
...
execute positioned ~ 200 ~ if entity @s[distance=..2] in the_end positioned 5000000 0 5000000 run summon armor_stand ~ ~ ~ {NoGravity:1b,Invulnerable:1b,Marker:1b,Invisible:1b,Tags:["spacegen"]}
